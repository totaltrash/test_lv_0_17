          ...
          <div class="flex items-center justify-between h-16">
            ...
            <div class="-mr-2 flex md:hidden">
              ...
              >
                ...
                -->
                <svg id="mobile-menu-button-open" class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                -->
                <svg id="mobile-menu-button-close" class="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
